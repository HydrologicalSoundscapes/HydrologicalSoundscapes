...
// import {dataSound} from "./sounds"

// function setupSound(arr) {
//   dataSound(arr)
// }

/**
 * The function BarChart is a modified version of the one
 * available at https://observablehq.com/@d3/sortable-bar-chart
...
export function BarChart(data, {
    ...
    let rect = svg.append("g")
      ...
      .data(I)
      .join("rect")
        .attr("class", "chart-bar") // I added this.
        // .attr("data-index", i=>`chart-bar-${i}`) // I added this.
        .property("key", i => X[i]) // for future transitions (this will be use to map a specific svg element to a specific datum, see https://github.com/d3/d3-selection/blob/v3.0.0/README.md#selection_data)
    ...
    function highlight(index=null) {
      if (index===null){
        svg.node().querySelectorAll(".chart-bar").forEach(b=>b.classList.remove("active"))
        return
      }
      svg.node().querySelectorAll(".chart-bar").forEach((b, i) => {
    ...
    // The Object.assign() method copies all enumerable own properties from one or more source objects to a target object. It returns the modified target object. (https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign)
